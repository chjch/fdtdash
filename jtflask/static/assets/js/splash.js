const JTSplashPage = (() => {
    ...
    const hideSplash = () => {
        ...
        twinLogoH1.addEventListener('animationend', () => {
            ...
            logoImage.classList.add('animate__animated', 'animate__slow', 'animate__fadeIn');
        });
        ...
        logoImage.addEventListener('animationend', () => {
            ...
            splashDiv.classList.add('animate__animated', "animate__slow", "animate__fadeOut", "animate__delay-1s");
            setTimeout(()=>{
